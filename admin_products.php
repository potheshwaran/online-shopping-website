...
<section class="add-products">
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      <div class="flex">
         <div class="inputBox">
         <input type="text" name="name" class="box" required placeholder="Enter the product name">
         <select name="category" class="box" required>
            <option value="" selected disabled>Select the category</option>
               <option value="vegitables">Vegetables</option>
               <option value="GROCERIES">GROCERIES</option>
               <option value="COUNTRY DRUGS">COUNTRY DRUGS</option>
               <option value="POOJA ITEMS">POOJA ITEMS</option>
         </select>
         </div>
         <div class="inputBox">
         <input type="number" min="0" name="price" class="box" required placeholder="Enter the product price">
         <input type="file" name="image" required class="box" accept="image/jpg, image/jpeg, image/png">
         </div>
      </div>
      <textarea name="details" class="box" required placeholder="Enter the product details" cols="30" rows="10"></textarea>
