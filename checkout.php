...
if(isset($_POST['order'])){
   ...
   $cart_total = 0;
   $cart_products = array(); // Initialize as an empty array, not an array with an empty string
...
<head>
   ...
   <title>PRAKASH STORE- Checkout</title>
   ...
   <form action="" method="POST">
        ...
        <div class="row">
            ...
            <div class="col">
                ...
                <div class="inputBox">
                    <span>Full name :</span>
                    <input type="text" placeholder="john deo" required name="name">
                </div>
                <div class="inputBox">
                    <span>number:</span>
                ...
                <div class="inputBox">
                    <span>Address :</span>
                    <input type="text" placeholder="room - street - locality" required name="street" >
                </div>
                <div class="inputBox">
                    <span>City :</span>
                    <input type="text" placeholder="mumbai" required name="city">
                </div>
                ...
                <div class="flex">
                    <div class="inputBox">
                        ...
                        <div class="inputBox">
                        <span>Zip code :</span>
                        <input type="text" placeholder="123 456" required name="pin_code">
                        </div>
                </div>
      ...
      <input type="submit" name="order" class="btn <?= ($cart_grand_total > 1)?'':'enable'; ?>" value="place order">
